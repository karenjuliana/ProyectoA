      ...
      <div class="container">
        ...
        <div class="casilla">
          <div class="form-group row">
              ...
              <input type="checkbox" class="form-check-input" id="materialInline1" value="si" name="adecuado">
            ...
            <div class="form-check form-check-inline">
              <input type="checkbox" class="form-check-input" id="parcialmente" value="si" name="parcialmente">
        ...
        <div class="form-group row">
          ...
          <textarea class="campo form-control" name="concepto" id="concepto" placeholder="¿Cual es tu Concepto?"></textarea>
        </div>
      </div>

      <input type="button" name="previous" class="previous btn btn-default" value="Previo" />
      <input type="submit" name="submit" class="submit btn btn-success" value="Enviar" id="submit_data" /><br>
    </fieldset>
  </form>
</div>
</div>
